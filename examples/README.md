...
- **`options`** — optional, graph-level settings (`type` can be `"directed"`, `"undirected"`, or `"mixed"`; `allowSelfLoops: true` enables self-loops; `multi: true` enables parallel edges)
