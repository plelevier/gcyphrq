...
describe('Engine - path functions', () => {
  describe('labels function', () => {
    it('returns labels as array', async () => {
      const g = new Graph();
    ...
    it('returns labels for multi-label nodes', async () => {
      const g = new Graph();
    ...
    it('returns empty array for null argument', async () => {
      const g = new Graph();
      g.addNode('a', { label: 'User', name: 'Alice' });
      const e = new AdvancedCypherGraphologyEngine(g);
  ...
  describe('path variables', () => {
    ...
    it('binds path variable for simple match', async () => {
      const g = setupGraph();
      const e = new AdvancedCypherGraphologyEngine(g);
    ...
    it('binds path variable for node-edge-node match', async () => {
      const g = setupGraph();
      const e = new AdvancedCypherGraphologyEngine(g);
    ...
    it('path variable with variable-length paths', async () => {
      const g = setupGraph();
      const e = new AdvancedCypherGraphologyEngine(g);
    ...
    it('path variable null-filled on OPTIONAL MATCH miss', async () => {
      const g = new Graph();
      g.addNode('a', { label: 'User', name: 'Alice' });
      g.addNode('b', { label: 'User', name: 'Bob' });
      g.addEdgeWithKey('a-friend-b', 'a', 'b', { type: 'FRIEND' });
    ...
    it('individual variables still work alongside path variable', async () => {
      const g = setupGraph();
      const e = new AdvancedCypherGraphologyEngine(g);
  ...
  describe('nodes function', () => {
    ...
    it('returns nodes from path variable', async () => {
      const g = setupGraph();
      const e = new AdvancedCypherGraphologyEngine(g);
    ...
    it('returns nodes for single-node path', async () => {
      const g = setupGraph();
      const e = new AdvancedCypherGraphologyEngine(g);
  ...
  describe('relationships function', () => {
    ...
    it('returns relationships from path variable', async () => {
      const g = setupGraph();
      const e = new AdvancedCypherGraphologyEngine(g);
    ...
    it('returns relationships for multi-hop path', async () => {
      const g = setupGraph();
      const e = new AdvancedCypherGraphologyEngine(g);
    ...
    it('returns array directly when argument is already an array', async () => {
      const g = setupGraph();
      const e = new AdvancedCypherGraphologyEngine(g);
