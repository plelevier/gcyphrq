...
describe('parseCypher - UNWIND with WHERE', () => {
  it('parses UNWIND with WHERE clause', () => {
  ...
  it('parses UNWIND with WHERE and MATCH', () => {
  ...
  it('parses UNWIND with WHERE using IS NOT NULL', () => {
  ...
  it('parses UNWIND with WHERE using CONTAINS', () => {
  ...
  it('parses UNWIND without WHERE (no where property)', () => {
  ...
  it('parses UNWIND with WHERE and WITH', () => {
  ...
  it('parses UNWIND with WHERE using IN operator', () => {
  ...
  it('parses UNWIND with WHERE using AND/OR', () => {
...
describe('Engine - UNWIND with WHERE', () => {
  it('filters elements with simple comparison', () => {
  ...
  it('filters with equality comparison', () => {
    const graphData = { nodes: [], edges: [] };
  ...
  it('filters with inequality comparison', () => {
    const graphData = { nodes: [], edges: [] };
  ...
  it('combines UNWIND WHERE with MATCH', () => {
    const graphData = {
      nodes: [
  ...
  it('combines UNWIND WHERE with aggregation', () => {
    const graphData = { nodes: [], edges: [] };
  ...
  it('combines UNWIND WHERE with WITH', () => {
    const graphData = { nodes: [], edges: [] };
  ...
  it('UNWIND WHERE with map property access', () => {
    const graphData = { nodes: [], edges: [] };
  ...
  it('UNWIND WHERE preserves outer context variables', () => {
    const graphData = {
      nodes: [
