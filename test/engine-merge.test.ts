...
describe('Engine - MERGE', () => {
  describe('execute - MERGE', () => {
    it('MERGE creates a node when it does not exist', async () => {
      const g = new Graph();
    ...
    it('MERGE matches an existing node', async () => {
      const g = new Graph();
      g.addNode('alice', { label: 'User', name: 'Alice' });
      const e = new AdvancedCypherGraphologyEngine(g);
    ...
    it('MERGE does not create duplicate nodes', async () => {
      const g = new Graph();
      g.addNode('alice', { label: 'User', name: 'Alice' });
      const e = new AdvancedCypherGraphologyEngine(g);

      const ast = parseCypher('MERGE (u:User {name: "Alice"}) RETURN u');
      const results1 = await e.execute(ast);
      expect(results1.length).toBe(1);
      const firstId = node(results1[0]!, 'u').id;

      const e2 = new AdvancedCypherGraphologyEngine(g);
      const results2 = await e2.execute(ast);
    ...
    it('MERGE with ON CREATE SET applies properties on creation', async () => {
      const g = new Graph();
      const e = new AdvancedCypherGraphologyEngine(g);
    ...
    it('MERGE with ON CREATE SET uses static arithmetic expression', async () => {
      const g = new Graph();
      const e = new AdvancedCypherGraphologyEngine(g);
    ...
    it('MERGE with ON CREATE SET uses dynamic property expression', async () => {
      const g = new Graph();
    ...
    it('MERGE with ON MATCH SET applies properties on match', async () => {
      const g = new Graph();
      g.addNode('alice', { label: 'User', name: 'Alice' });
      const e = new AdvancedCypherGraphologyEngine(g);
    ...
    it('MERGE with both ON CREATE and ON MATCH', async () => {
      const g = new Graph();
      g.addNode('alice', { label: 'User', name: 'Alice' });
      const e = new AdvancedCypherGraphologyEngine(g);
      ...
      const results2 = await e2.execute(ast2);
      expect(node(results2[0]!, 'u').status).toBe('new');
    });

    it('MERGE with relationship chain creates missing nodes and edge', async () => {
      const g = new Graph();
      const e = new AdvancedCypherGraphologyEngine(g);
    ...
    it('MERGE with relationship chain matches existing nodes and creates edge', async () => {
      const g = new Graph();
      g.addNode('alice', { label: 'User', name: 'Alice' });
    ...
    it('MERGE with relationship chain does not create duplicate edge', async () => {
      const g = new Graph();
      g.addNode('alice', { label: 'User', name: 'Alice' });
      g.addNode('bob', { label: 'User', name: 'Bob' });
    ...
    it('MERGE followed by MATCH uses created node', async () => {
      const g = new Graph();
      g.addNode('alice', { label: 'User', name: 'Alice' });
      g.addNode('bob', { label: 'User', name: 'Bob' });
      g.addEdge('alice', 'bob', { type: 'FRIEND' });
    ...
    it('MERGE with multiple incoming contexts creates one node per context', async () => {
      const g = new Graph();
      g.addNode('alice', { label: 'User', name: 'Alice' });
      g.addNode('bob', { label: 'User', name: 'Bob' });
      const e = new AdvancedCypherGraphologyEngine(g);
    ...
    it('MERGE with undirected relationship', async () => {
      const g = new Graph();
      g.addNode('alice', { label: 'User', name: 'Alice' });
      g.addNode('bob', { label: 'User', name: 'Bob' });
      const e = new AdvancedCypherGraphologyEngine(g);
    ...
    it('MERGE with ON CREATE SET on relationship', async () => {
      const g = new Graph();
      g.addNode('alice', { label: 'User', name: 'Alice' });
      g.addNode('bob', { label: 'User', name: 'Bob' });
      const e = new AdvancedCypherGraphologyEngine(g);
    ...
    it('MERGE with WHERE matches only nodes satisfying the condition', async () => {
      const g = new Graph();
    ...
    it('MERGE with WHERE does not match when condition fails', async () => {
      const g = new Graph();
      g.addNode('bob', { label: 'User', name: 'Bob', age: 17 });
      const e = new AdvancedCypherGraphologyEngine(g);
    ...
    it('MERGE with WHERE creates node when none exist', async () => {
      const g = new Graph();
      const e = new AdvancedCypherGraphologyEngine(g);
    ...
    it('MERGE with DELETE in ON MATCH deletes the matched node', async () => {
      const g = new Graph();
      g.addNode('alice', { label: 'User', name: 'Alice' });
      const e = new AdvancedCypherGraphologyEngine(g);
    ...
    it('MERGE with DELETE in ON MATCH deletes the matched edge', async () => {
      const g = new Graph();
      g.addNode('alice', { label: 'User', name: 'Alice' });
      g.addNode('bob', { label: 'User', name: 'Bob' });
      g.addEdge('alice', 'bob', { type: 'FRIEND' });
    ...
    it('MERGE with REMOVE label in ON MATCH', async () => {
      const g = new Graph();
    ...
    it('MERGE with REMOVE property in ON MATCH', async () => {
      const g = new Graph();
    ...
    it('MERGE with SET and REMOVE in ON MATCH', async () => {
      const g = new Graph();
    ...
    it('MERGE with SET and DELETE in ON CREATE', async () => {
      const g = new Graph();
      const e = new AdvancedCypherGraphologyEngine(g);
    ...
    it('MERGE with WHERE and DELETE on relationship chain', async () => {
      const g = new Graph();
      g.addNode('alice', { label: 'User', name: 'Alice', age: 30 });
    ...
    it('MERGE with WHERE and REMOVE on relationship chain', async () => {
      const g = new Graph();
      g.addNode('alice', { label: 'User', name: 'Alice', age: 30 });
      g.addNode('bob', { label: 'User', name: 'Bob', age: 25 });
      g.addEdge('alice', 'bob', { type: 'FRIEND', since: 2020 });
    ...
    it('MERGE with WHERE and DELETE on relationship chain creates when WHERE fails', async () => {
      const g = new Graph();
    ...
    it('MERGE with DELETE in ON CREATE without WHERE', async () => {
      const g = new Graph();
      g.addNode('alice', { label: 'User', name: 'Alice' });
      const e = new AdvancedCypherGraphologyEngine(g);
    ...
    it('MERGE with REMOVE in ON CREATE without WHERE', async () => {
      const g = new Graph();
      g.addNode('alice', { label: ['User', 'Admin'], name: 'Alice' });
      const e = new AdvancedCypherGraphologyEngine(g);
    ...
    it('MERGE with WHERE and both ON CREATE and ON MATCH', async () => {
      const g = new Graph();
      g.addNode('alice', { label: 'User', name: 'Alice', age: 30 });
      const e = new AdvancedCypherGraphologyEngine(g);
    ...
    it('MERGE with WHERE containing bracket index access', async () => {
      const g = new Graph();
    ...
    it('MERGE with WHERE containing property named "on"', async () => {
      const g = new Graph();
    ...
    it('MERGE with WHERE containing "ON MATCH" in string literal', async () => {
      const g = new Graph();
