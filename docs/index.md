...
| Scalar functions (`toLower`, `toUpper`, `substring`, `split`, `repl`, `trim`, `length`, `coalesce`, `head`, `last`, `tail`, `reverse`, `size`, `id`, `labels` (RETURN), `labelsOf` (everywhere), `nodes`, `relationships`, `reltype`, `toString`, `toInteger`, `toFloat`) | <span class="badge badge-success">✅</span> |
