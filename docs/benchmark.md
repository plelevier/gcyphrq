...
layout: default
title: Benchmark
description: Query performance benchmarks for gcyphrq — indexed vs non-indexed modes.
---
...
- **[Library API]({{ '/library-api/' | relative_url }})** — Performance considerations and API reference
